...
namespace LL
{
    public partial class LL : UserControl
    {
        ...
        //DV1 is open or not
        private bool _bDV1Open = false;
        [Category("DV1Open"), Description("DV1 is open or not")]
        public bool DV1Open
        {
            get { return _bDV1Open; }
            set
            {
                _bDV1Open = value;
        ...
        [Category("TID"), Description("LL trate ID")]
        public string TID
        {
            get { return _sTID; }
            set { _sTID = value; }
        ...
        #region is LL in vacuum
        private bool _bIsVac = false;
        [Category("IsVacuum"), Description("Is LL in vacuum")]
        public bool IsVac
        {
            get { return _bIsVac; }
            set
            {
                ...
                if (_bIsVac) //in vacuum change Back color
                {
                    ...
                    os_LLATMG.FillColor = SystemColors.Control;
                    LLPHGauge.Signal = 1;
                }
                else
                {
                    ...
                    os_LLATMG.FillColor = Color.Chartreuse;
                    LLPHGauge.Signal = 2;
                }
            }
        }
        ...
        [Category("IsATM"), Description("Is LL in ATM")]
        public bool IsATM
        {
            get { return _bIsATM; }
            set
        ...
        #region is LL pressure value
        private string _sPreVal = "";
        [Category("PreVal"), Description("LL pressure value")]
        ...
        #region is LL 門變色
        private string _DV1_Up_InterLock = "";
        [Category("DV1_Up_InterLock"), Description("DV1 Up InterLock")]
        public string DV1_Up_InterLock
        {
            get { return _DV1_Up_InterLock; }
            set
            {
                _DV1_Up_InterLock = value;
                if (_DV1_Up_InterLock.Equals("1"))
        ...
        private string _DV1_Down_InterLock = "";
        [Category("DV1_Down_InterLock"), Description("DV1 Down InterLock")]
        public string DV1_Down_InterLock
        {
            get { return _DV1_Down_InterLock; }
            set
            {
                _DV1_Down_InterLock = value;
                if (_DV1_Down_InterLock.Equals("1"))
        ...
        private void rsUpBtn1_Click(object sender, EventArgs e)
        {
            if (this.AutoMode != true)
            {
                if (DV1Open == true)
                {
                    MessageBox.Show("DV1 is already open ", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    return;
                }
        ...
        private void rsDownBtn1_Click(object sender, EventArgs e)
        {
            if (this.AutoMode != true)
            {
                if (DV1Open == false)
                {
                    MessageBox.Show("DV1 is already close ", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    return;
                }
