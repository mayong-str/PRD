...
namespace RPD_1GUN
{
    ...
    class clsDBN
    {
        ...
        private static string XML_Path = Application.StartupPath + "\\DBSetting.xml";
        private static string MyPath = Application.StartupPath + "\\SQLError\\";
        private static string MyExportPath = Application.StartupPath + "\\ExportData\\";
       
        private static string ConnectionString = @"";
        private static List<SqlParameter> sSqlParameter = new List<SqlParameter>();
        ...
        public static System.Collections.Generic.List<SqlParameter> SqlParameter
        {
        ...
        public static int ExecuteSqlCommandTest(string SqlCommand)
        {
            int MyRow = 0;
            SqlCommand sSqlCommand = new SqlCommand();
            sSqlCommand.CommandTimeout = 300; //設置SqlCommand TimeOut 300
        ...
        public static int ExecuteSqlCommand(string SqlCommand, string ReplaceConStr)
        {
        ...
        public static bool ExecuteSqlCommandBool(string SqlCommand)
        {
            //int MyRow = 0;
            bool MyRow = false;
            System.Data.Common.DbDataReader SqlRs;
            SqlCommand sSqlCommand = new SqlCommand();
            sSqlCommand.CommandTimeout = 300; //設置SqlCommand TimeOut 300
            sSqlCommand.Connection = new SqlConnection(ConnectionString);
            ...
            lock (sSqlCommand.Connection)
            {
                ...
                //SqlDbCmd.Connection = SqlDBConn;
                    SqlRs = sSqlCommand.ExecuteReader();
        ...
        public static object GetObject(string SqlCommand)
        {
        ...
        public static object GetObject(string SqlCommand, string ReplaceConStr)
        {
            object obj = new object();
            obj = null;
            SqlCommand sSqlCommand = new SqlCommand();
        ...
        public static DataTable GetTable(string SqlCommand)
        {
            ...
            lock (sSqlCommand.Connection)
            {
                try
                {
                    ...
                    SqlDbDs.Clear();
                    sSqlDataAdapter.Fill(SqlDbDs);

                    MyTable = SqlDbDs.Tables[0];
        ...
        public static DataTable GetTable(string SqlCommand, string ReplaceConStr)
        {
            DataTable MyTable = new DataTable();
            SqlCommand sSqlCommand = new SqlCommand();
            sSqlCommand.CommandTimeout = 300; //設置SqlCommand TimeOut 300
        ...
        public static DataRow GetRow(string SqlCommand)
        {
        ...
        public static DataRow GetRow(string SqlCommand, string ReplaceConStr)
        {
            DataTable MyRow = new DataTable();
            SqlCommand sSqlCommand = new SqlCommand();
            sSqlCommand.CommandTimeout = 300; //設置SqlCommand TimeOut 300
        ...
        public static void GetDBtoCmb(string SqlCommand, ref ComboBox ComboBox)
        {
        ...
        public static void GetDBtoCmb(string SqlCommand, string ReplaceConStr, ref ComboBox ComboBox)
        {
            ComboBox.Items.Clear();
            SqlCommand sSqlCommand = new SqlCommand();
            sSqlCommand.CommandTimeout = 300; //設置SqlCommand TimeOut 300
        ...
        public static void GetDBtoCklbx(string SqlCommand, ref CheckedListBox CheckListBox)
        {
        ...
        public static void GetDBtoCklbx(string SqlCommand, string ReplaceConStr, ref CheckedListBox CheckListBox)
        {
            CheckListBox.Items.Clear();
            SqlCommand sSqlCommand = new SqlCommand();
            sSqlCommand.CommandTimeout = 300; //設置SqlCommand TimeOut 300
        ...
        public static string[,] GetDBtoDR(string SqlCommand)
        {
            SqlCommand sSqlCommand = new SqlCommand();
            sSqlCommand.CommandTimeout = 300; //設置SqlCommand TimeOut 300
            sSqlCommand.Connection = new SqlConnection(ConnectionString);
        ...
        public static string[,] GetDBtoDR(string SqlCommand, string ReplaceConStr)
        {
            SqlCommand sSqlCommand = new SqlCommand();
            sSqlCommand.CommandTimeout = 300; //設置SqlCommand TimeOut 300
            sSqlCommand.Connection = new SqlConnection(ReplaceConStr);
        ...
        public static void SendEmail(string ServerAddress, string ServerPassword, string FromUser, string ToUser, string ToEmail, string Subject, string Content)
        {
        ...
        public static void ExportDataTableToCsv(DataTable dt, string FileName, string[] ColumnName, bool HasColumnName, string DestPath)
        {
        ...
        public static void ExportDataTableToCsv(DataTable dt, string FileName)
        {
            ...
            if (!Directory.Exists(MyExportPath))
                Directory.CreateDirectory(MyExportPath);

            //存成檔案
            string strFile = MyExportPath + FileName;
            if (!string.IsNullOrEmpty(strValue))
            {
        ...
        public static void SendMail(string FromMail, string sName, string ToMail, string sSubject, string sMessage)
        {
        ...
        /// <param name="sSubject"></param>
        /// <param name="sMessage"></param>
        public static void WriteXml(string IP, string DATABASE, string ACCOUNT, string PASSWORD)
        {
            try
            {
